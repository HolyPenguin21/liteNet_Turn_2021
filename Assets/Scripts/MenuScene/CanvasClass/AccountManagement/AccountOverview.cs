...
public class AccountOverview
{
    ...
    public AccountOverview(AccountManagementMenu accountManagementMenu)
    {
        ...
        accountManagementMenu.overviewPanel_go = MonoBehaviour.Instantiate(Resources.Load("UI_MainMenu/AccountPanel/Overview_Panel", typeof(GameObject)), accountManagementMenu.go.transform) as GameObject;
