...
public class CharactersPanel
{
    ...
    public CharactersPanel(AccountManagementMenu accountManagementMenu)
    {
        ...
        accountManagementMenu.charactersPanel_go = MonoBehaviour.Instantiate(Resources.Load("UI_MainMenu/AccountPanel/CharactersPanel/Characters_Panel", typeof(GameObject)), accountManagementMenu.go.transform) as GameObject;
    ...
    public void Update_HeroView()
    {
        ...
        for (int x = 0; x < GameData.inst.account.heroes.Count; x++)
        {
            ...
            GameObject cButton_obj = MonoBehaviour.Instantiate(Resources.Load("UI_MainMenu/AccountPanel/CharactersPanel/Character_Button", typeof(GameObject)), heroContent_tr) as GameObject;
    ...
    public void Update_HeroCharactersView()
    {
        ...
        for (int x = 0; x < h.battleCharacters.Count; x++)
        {
            ...
            GameObject hCharacterButton = MonoBehaviour.Instantiate(Resources.Load("UI_MainMenu/AccountPanel/CharactersPanel/Character_Button", typeof(GameObject)), hCharactersContent_tr) as GameObject;
    ...
    public void Update_PlayerCharactersView()
    {
        ...
        for (int x = 0; x < GameData.inst.account.сharacters.Count; x++)
        {
            ...
            GameObject hCharacterButton = MonoBehaviour.Instantiate(Resources.Load("UI_MainMenu/AccountPanel/CharactersPanel/Character_Button", typeof(GameObject)), pCharactersContent_tr) as GameObject;
            Menu_Character_Button menu_cButton = hCharacterButton.GetComponent<Menu_Character_Button>();
